...
import random
# u Model ide sva komunikacija s bazom podataka ili nečim što simulira bazu podataka poput liste u ovom sluč.
class AnjcModel:
    def __init__(self):
...
# u view ide sve ono što korisnik vidi (objekti, gumbovi i sl.)
class AnjcView:
    ...
    def player_input(self):
        ...
        # while petlja za Meni u kojem su vuci ili stop
            while True:
                ...
                vuci = input("Želite li odabrati Vuci ili Stop. V/S:  ").lower() 
                if vuci in ("vuci", "v"):
